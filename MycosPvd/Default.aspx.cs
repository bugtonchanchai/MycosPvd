...
namespace MycosPvd
{
    ...
    public class Utils
    {
        public static string getConnectionString()
        {
            try
            {
                //return ConfigurationManager.ConnectionStrings["LocalConnection"].ConnectionString.ToString();     // local db
                return ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString.ToString();     // azure db
            }
            catch (Exception ex)
            {
                throw ex;
